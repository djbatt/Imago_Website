            ...
            <Box pad="large">
              ...
              <Box width="large">
                <Paragraph color="text" size="large" fill>
                  Our stylists have years of experience and have trained at
                  world renowned academies. With training from, Devachan, Nick
                  Arrojo, Toni & Guy, L’Oreal Professional, Eva Scrivo and many
                  in-salon training sessions.
                </Paragraph>
              </Box>
              <Link to="/book-online" css={`text-decoration: none; color: #f8f8f8`}>
                <Box
                  direction="row"
                  gap="small"
                  border={{
