...
export default () => {
  const data = useStaticQuery(graphql`
    query {
      file(relativePath: { eq: "HairColor.jpeg" }) {
        childImageSharp {
          fluid(maxWidth: 2000) {
            ...
            <Box pad="large">
              ...
              <Box width="large">
                <Paragraph color="text" size="large" fill>
                  We are eager to welcome you to Imago and share our expertise
                  with you. Whether you need a complete makeover or a few
                  highlights, our caring stylists will leave you looking and
                  feeling your best.
                </Paragraph>
              </Box>
            </Box>
